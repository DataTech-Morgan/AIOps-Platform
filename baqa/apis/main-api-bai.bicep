...
resource apiOperations 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: apiConfiguration
  name: 'post-requirementsBai'
  properties: {
    displayName: 'requirementsBai'
    method: 'POST'
    urlTemplate: '/requirementsBai'
    templateParameters: [
    ]
    request: {
    }
...
resource polOperations 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  name: 'policy'
  parent: apiOperations
  properties: {
    format: 'xml'
...
resource apiOperations1 'Microsoft.ApiManagement/service/apis/operations@2023-03-01-preview' = {
  parent: apiConfiguration
  name: 'get-requirementsBai'
  properties: {
    displayName: 'requirementsBai'
    method: 'GET'
    urlTemplate: '/requirementsBai'
...
resource polOperations1 'Microsoft.ApiManagement/service/apis/operations/policies@2023-03-01-preview' = {
  name: 'policy'
  parent: apiOperations1
  properties: {
    format: 'xml'
    value: '<policies><inbound><base /><set-backend-service id="apim-generated-policy" backend-id="${apiBackendName}" /></inbound><backend><base /></backend><outbound><base /></outbound><on-error><base /></on-error></policies>'
  }
